...
public class Main {
    public static void main(String[] args) {
        ...
        // Если год високосный, то должно быть выведено “*номер года —* високосный год”. Если год не високосный, то, соответственно: “*номер года —* не **високосный год”.
        System.out.println("Задание 1");
        int year = 2022;        //какой год анализируем
        checkLeapYear(year);        //вызываем метод оперделения високосности
        ...
        byte clientOS = 1;      //ОС клиента (0 — iOS, 1 — Android.)
        short clientDeviceYear = 2018;      //год производства телефона
        appVersionChecker(clientOS, clientDeviceYear);
